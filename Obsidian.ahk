...
AddToFile()
{
    ...
    RunWait, "C:\git\AHK\PrintscreenToTodo\bin\Release\net7.0-windows\PrintscreenToTodo.exe" "false"
}
...
#+d::
    {
        RunWait, "C:\git\AHK\NoteWork\bin\Release\net7.0-windows\NoteWork.exe"
        return
    }
...
~#+t::
    {
        ...
        RunWait, "C:\git\AHK\PrintscreenToTodo\bin\Release\net7.0-windows\PrintscreenToTodo.exe" "true"
        return
    }
